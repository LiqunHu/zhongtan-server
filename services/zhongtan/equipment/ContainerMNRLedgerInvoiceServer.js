...
exports.searchAct = async req => {
  ...
  for(let r of result.data) {
    ...
    if(r.mnr_ledger_bl && r.mnr_ledger_container_no && r.mnr_ledger_container_size && r.mnr_ledger_destination && r.mnr_ledger_cargo_type 
      && r.mnr_ledger_corresponding_payer_id && r.mnr_ledger_vessel_ata &&  r.mnr_ledger_vessel_name && r.mnr_ledger_vessel_voyage && r.mnr_ledger_actual_charge_amount) {
