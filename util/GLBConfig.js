module.exports = {
  ...
  EDI_EMAIL_RECEIVER: 'EDI@TICTS.COM;billing@ticts.com',
  INVOICE_CARGO_TYPE: [
    { id: 'IM', text: 'IMPORT' },
    { id: 'TR', text: 'TRANSIT' }
  ],
  ...
  ICD_EDI_EMAIL_SENDER: 'OPERATIONS@SINOTASHIP.COM', //'impops_sinotaship@163.com', //'OPERATIONS@SINOTASHIP.COM',
  ...
  EMPTY_RELEASE_EMAIL_SENDER: 'DEMURRAGE@SINOTASHIP.COM', // 'expops_sinotaship@163.com', //'DEMURRAGE@SINOTASHIP.COM',
