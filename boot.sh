...
docker run --rm -p 0.0.0.0:33306:3306 --name serverdb -v $PWD/mysql/logs:/logs -v $PWD/mysql/data:/var/lib/mysql -e TZ=Europe/Paris -e MYSQL_ROOT_PASSWORD=123456 -d mysql:5.7
